...
//		Click Product tab
        ...
        //pagination - if value not found in the current page then it will move to the next page using pagination.
        if (ActualRow == 0) {
            ActualRow = ProductsTab.getTblSegmentPagination(SegmentGroupName);
        }
