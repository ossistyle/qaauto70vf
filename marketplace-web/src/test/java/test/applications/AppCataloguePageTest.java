...
import pages.applications.AppCatalogPage;
import test.BaseTest;
import utils.allure.mock.AppMock;
...
//        appCatalogPage.navigate();
    ...
    @Test (description = "User be able to see app images, app names, app descriptions on the App Catalog page > Card view test.applications", groups = {"ui", "regression"}, testName = "Card view test.applications")
    @Epic ("")
    @Feature ("")
    @Link ("10204018")
    @Severity (SeverityLevel.NORMAL)
    @Description ("User be able to see app images, app names, app descriptions on the App Catalog page > Card view test.applications")
    ...
    @Test (description = "User be able to see app images, app names, app descriptions on the App Catalog page > Grid view test.applications", groups = {"ui", "regression"}, testName = "Grid view test.applications")
    @Feature ("")
    @Link ("")
    @Severity (SeverityLevel.NORMAL)
    @Description ("User be able to see app images, app names, app descriptions on the App Catalog page > Grid view test.applications")
